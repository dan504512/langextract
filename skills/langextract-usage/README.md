...
|---|---|---|
| [Google Antigravity](https://antigravity.google/docs/skills) | `<workspace>/.agents/skills/langextract-usage/` | `~/.gemini/antigravity/skills/langextract-usage/` |
...
Notes:
- **Antigravity** also recognizes legacy `<workspace>/.agent/skills/`
  (singular) for backward compatibility; new installs should use
